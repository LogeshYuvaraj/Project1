...
public class ViewActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle(Html.fromHtml("<small>View Activity  </small>"));
        }

        session = new SessionManagement(ViewActivity.this);
        ...
        if (ConnectivityReceiver.isConnected(ViewActivity.this)) {
            new GETActivitiesReport().execute();
        } else {
        ...
        fromdate_et.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dp = new DatePickerDialog(ViewActivity.this,
        ...
        todate_et.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dp1 = new DatePickerDialog(ViewActivity.this,
                        new DatePickerDialog.OnDateSetListener() {
    ...
    private class GETActivitiesReport extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try {
                ...
                final String METHOD_NAME = "IndusMobileSales_GETActivitiesReport";
                final String SOAP_ACTION = "http://tempuri.org/IndusMobileSales_GETActivitiesReport";
                final String URL = "http://103.48.182.209/ravelqc/Service.asmx?op=IndusMobileSales_GETActivitiesReport";
                Log.e("URL", URL);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (jsonArray2.length() == 0) {
                Toast.makeText(ViewActivity.this, "NoDataFound", Toast.LENGTH_SHORT).show();
                viewactivityRecycle.setVisibility(View.GONE);
            } else {
                viewactivityRecycle.setVisibility(View.VISIBLE);
                viewactivityRecycle.setLayoutManager(new LinearLayoutManager(ViewActivity.this));
